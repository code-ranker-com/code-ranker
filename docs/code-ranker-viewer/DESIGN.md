...
ancestor path) and clicking an expanded folder cluster's **name** drills into it — its **background is inert** (the folder is already expanded; only the path label navigates). **Callers / dependencies**
