...
|---|---------|----------|----------|---------|
| 1 | **app** — the release | `[workspace.package] version` (`env!("CARGO_PKG_VERSION")`) | root `Cargo.toml` | `5.0.4` |
...
Plain SemVer of the release (`5.0.4`). Bumped with `make bump VERSION=…`,
